function Boss(game, x, y) {
  ...
  this.y = BOSS.startY;
  this.alive = true;
  this.horizontalDirection = this.player.x < this.x ? -BOSS.speed : BOSS.speed;
  this.verticalDirection = this.player.y < this.y ? -BOSS.speed : BOSS.speed;
